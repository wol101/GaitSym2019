...
def check_mass_properties():
    ...
    for child in input_root:
        ...
        if child.tag == "BODY":
            ...
            if isclose(mass, mass_properties['mass'], args.tolerance, args.tolerance):
            ...
            if isclose(moments_of_inertia[0], mass_properties['inertial_tensor'][0][0], args.tolerance, args.tolerance):
            ...
            if isclose(moments_of_inertia[1], mass_properties['inertial_tensor'][1][1], args.tolerance, args.tolerance):
            ...
            if isclose(moments_of_inertia[2], mass_properties['inertial_tensor'][2][2], args.tolerance, args.tolerance):
            ...
            if isclose(moments_of_inertia[3], mass_properties['inertial_tensor'][0][1], args.tolerance, args.tolerance):
            ...
            if isclose(moments_of_inertia[4], mass_properties['inertial_tensor'][0][2], args.tolerance, args.tolerance):
            ...
            if isclose(moments_of_inertia[5], mass_properties['inertial_tensor'][1][2], args.tolerance, args.tolerance):
...
def isclose(a, b, add_tol, mul_tol):
    diff = math.fabs(a - b)
    if diff <= add_tol:
        return True
    if diff / max(math.fabs(a), math.fabs(b)) <= mul_tol:
        return True
    return False
