// wis - original epsilon is too big to allow small triangles in the mesh
// the chosen value is fairly arbitrary - it is only compared to zero so it can be quite small
//#define LOCAL_EPSILON 0.000001f
#define LOCAL_EPSILON FLT_MIN
// wis
