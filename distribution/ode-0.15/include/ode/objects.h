...
// wis 30-12-2007 a new joint type to help constrain to 2D
/**
 * @brief Create a new joint of the floating hinge type.
 * @ingroup joints
 * @param dJointGroupID set to 0 to allocate the joint normally.
 * If it is nonzero the joint is allocated in the given joint group.
 */
ODE_API dJointID dJointCreateFloatingHinge (dWorldID, dJointGroupID);

/**
 * @ingroup joints
 */
ODE_API void dJointSetFloatingHingeAxis (dJointID j, dReal x, dReal y, dReal z);

/**
 * @ingroup joints
 */
ODE_API void dJointSetFloatingHingeParam (dJointID j, int parameter, dReal value);

/**
 * @ingroup joints
 */
ODE_API void dJointAddFloatingHingeTorque (dJointID j, dReal torque);

/**
 * @brief get joint parameter
 * @ingroup joints
 */
ODE_API void dJointGetFloatingHingeAxis (dJointID j, dVector3 result);

/**
 * @brief get joint parameter
 * @ingroup joints
 */
ODE_API dReal dJointGetFloatingHingeParam (dJointID j, int parameter);

/**
 * @brief get joint parameter
 * @ingroup joints
 */
ODE_API dReal dJointGetFloatingHingeAngle (dJointID j);

/**
 * @brief get joint parameter
 * @ingroup joints
 */
ODE_API dReal dJointGetFloatingHingeAngleRate (dJointID j);

// wis 6-1-2011 - need access to reference1 and reference2
/**
 * @brief Get the Euler Reference Vectors (state saving only)
 * @ingroup joints
 */
ODE_API void dJointGetAMotorEulerReferenceVectors( dJointID j , dVector3 ref1 , dVector3 ref2 );

/**
 * @brief Set the Euler Reference Vectors (state restore only)
 * @ingroup joints
 */
ODE_API void dJointSetAMotorEulerReferenceVectors( dJointID j, dVector3 ref1 , dVector3 ref2 );
