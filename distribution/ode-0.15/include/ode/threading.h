...
typedef struct dxThreadingFunctionsInfo
{
   ...
   * (translated from Ukranian) Ancient legends tell that every brave man who dares to break the taboo
   * and use the forbidden code, will suffer a terrible curse and imediately start to make errors
   *
