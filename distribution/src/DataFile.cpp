...
bool DataFile::RetrieveParameter(const char * const param, size_t n,
...
bool DataFile::RetrieveRangedParameter(const char * const param, size_t n,
                                       double *val, bool searchFromStart)
{
    size_t i;
    if (FindParameter(param, searchFromStart)) return true;
...
// returns true on error
bool DataFile::ReadNextLine2(char *line, size_t size, bool ignoreEmpty,
...
// (comment string to end of line)
// returns true on error
bool DataFile::ReadNextLine(char *line, size_t size, bool ignoreEmpty,
