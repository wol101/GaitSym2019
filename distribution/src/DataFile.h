...
public:
    ...
    bool RetrieveParameter(const char * const param,
                           char *val, size_t size, bool searchFromStart = true);
    bool RetrieveParameter(const char * const param,
                           char **val, size_t *size, bool searchFromStart = true);
    ...
    bool RetrieveQuotedStringParameter(const char * const param, char **val,
                                       size_t *size, bool searchFromStart = true);
    ...
    bool ReadNextLine(char *line, size_t size, bool ignoreEmpty,
                      char commentChar = 0, char continuationChar = 0);
    bool ReadNextLine2(char *line, size_t size, bool ignoreEmpty,
                       const char *commentString, const char *continuationString = nullptr);

    // retrieve arrays
    // the file is searched for the parameter and then the next token is read
    bool RetrieveParameter(const char * const param, size_t n,
                           int *val, bool searchFromStart = true);
    bool RetrieveParameter(const char * const param, size_t n,
                           double *val, bool searchFromStart = true);
    bool RetrieveRangedParameter(const char * const param, size_t n,
                                 double *val, bool searchFromStart = true);
