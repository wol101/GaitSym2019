...
#ifndef SIMULATIONWINDOWQT3D_H
#define SIMULATIONWINDOWQT3D_H
...
class SimulationWindowQt3D : public Qt3DExtras::Qt3DWindow
{
    Q_OBJECT
public:
    SimulationWindowQt3D(QScreen *screen = nullptr);
    virtual ~SimulationWindowQt3D() Q_DECL_OVERRIDE;
...
private:
    ...
    QMouseEvent *m_mouseClickEventPtr = nullptr;
